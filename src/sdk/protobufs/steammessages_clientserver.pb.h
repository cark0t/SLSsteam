...
class CMsgGameServerPolicyUpdate;
struct CMsgGameServerPolicyUpdateDefaultTypeInternal;
extern CMsgGameServerPolicyUpdateDefaultTypeInternal _CMsgGameServerPolicyUpdate_default_instance_;
PROTOBUF_NAMESPACE_OPEN
...
template<> ::CMsgGameServerPolicyUpdate* Arena::CreateMaybeMessage<::CMsgGameServerPolicyUpdate>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class CMsgClientP2PConnectionInfo PROTOBUF_FINAL :
 ...
 public:
  ...
  bool has_app_id_secondary() const;
  private:
  bool _internal_has_app_id_secondary() const;
  public:
  void clear_app_id_secondary();
  ::PROTOBUF_NAMESPACE_ID::uint32 app_id_secondary() const;
  void set_app_id_secondary(::PROTOBUF_NAMESPACE_ID::uint32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::uint32 _internal_app_id_secondary() const;
  void _internal_set_app_id_secondary(::PROTOBUF_NAMESPACE_ID::uint32 value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::uint32 app_id_secondary_;
  friend struct ::TableStruct_steammessages_5fclientserver_2eproto;
};
// -------------------------------------------------------------------
...
class CMsgGameServerPolicyUpdate PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:CMsgGameServerPolicyUpdate) */ {
 public:
  inline CMsgGameServerPolicyUpdate() : CMsgGameServerPolicyUpdate(nullptr) {}
  virtual ~CMsgGameServerPolicyUpdate();
  explicit constexpr CMsgGameServerPolicyUpdate(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  CMsgGameServerPolicyUpdate(const CMsgGameServerPolicyUpdate& from);
  CMsgGameServerPolicyUpdate(CMsgGameServerPolicyUpdate&& from) noexcept
    : CMsgGameServerPolicyUpdate() {
    *this = ::std::move(from);
  }

  inline CMsgGameServerPolicyUpdate& operator=(const CMsgGameServerPolicyUpdate& from) {
    CopyFrom(from);
    return *this;
  }
  inline CMsgGameServerPolicyUpdate& operator=(CMsgGameServerPolicyUpdate&& from) noexcept {
    if (GetArena() == from.GetArena()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const CMsgGameServerPolicyUpdate& default_instance() {
    return *internal_default_instance();
  }
  static inline const CMsgGameServerPolicyUpdate* internal_default_instance() {
    return reinterpret_cast<const CMsgGameServerPolicyUpdate*>(
               &_CMsgGameServerPolicyUpdate_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    20;

  friend void swap(CMsgGameServerPolicyUpdate& a, CMsgGameServerPolicyUpdate& b) {
    a.Swap(&b);
  }
  inline void Swap(CMsgGameServerPolicyUpdate* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(CMsgGameServerPolicyUpdate* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  inline CMsgGameServerPolicyUpdate* New() const final {
    return CreateMaybeMessage<CMsgGameServerPolicyUpdate>(nullptr);
  }

  CMsgGameServerPolicyUpdate* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<CMsgGameServerPolicyUpdate>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const CMsgGameServerPolicyUpdate& from);
  void MergeFrom(const CMsgGameServerPolicyUpdate& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(CMsgGameServerPolicyUpdate* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "CMsgGameServerPolicyUpdate";
  }
  protected:
  explicit CMsgGameServerPolicyUpdate(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  bool has_app_id_aux() const;
  private:
  bool _internal_has_app_id_aux() const;
  public:
  void clear_app_id_aux();
  ::PROTOBUF_NAMESPACE_ID::uint32 app_id_aux() const;
  void set_app_id_aux(::PROTOBUF_NAMESPACE_ID::uint32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::uint32 _internal_app_id_aux() const;
  void _internal_set_app_id_aux(::PROTOBUF_NAMESPACE_ID::uint32 value);
  public:

  // @@protoc_insertion_point(class_scope:CMsgGameServerPolicyUpdate)
 private:
  class _Internal;
  ...
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  ::PROTOBUF_NAMESPACE_ID::uint32 app_id_;
  ::PROTOBUF_NAMESPACE_ID::uint32 app_id_aux_;
  friend struct ::TableStruct_steammessages_5fclientserver_2eproto;
};
// -------------------------------------------------------------------
...
// optional uint32 app_id_secondary = 7;
inline bool CMsgClientP2PConnectionInfo::_internal_has_app_id_secondary() const {
  bool value = (_has_bits_[0] & 0x00000040u) != 0;
  return value;
}
inline bool CMsgClientP2PConnectionInfo::has_app_id_secondary() const {
  return _internal_has_app_id_secondary();
}
inline void CMsgClientP2PConnectionInfo::clear_app_id_secondary() {
  app_id_secondary_ = 0u;
  _has_bits_[0] &= ~0x00000040u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 CMsgClientP2PConnectionInfo::_internal_app_id_secondary() const {
  return app_id_secondary_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 CMsgClientP2PConnectionInfo::app_id_secondary() const {
  // @@protoc_insertion_point(field_get:CMsgClientP2PConnectionInfo.app_id_secondary)
  return _internal_app_id_secondary();
}
inline void CMsgClientP2PConnectionInfo::_internal_set_app_id_secondary(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _has_bits_[0] |= 0x00000040u;
  app_id_secondary_ = value;
}
inline void CMsgClientP2PConnectionInfo::set_app_id_secondary(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_app_id_secondary(value);
  // @@protoc_insertion_point(field_set:CMsgClientP2PConnectionInfo.app_id_secondary)
}
...
// optional uint32 app_id = 1;
inline bool CMsgGameServerPolicyUpdate::_internal_has_app_id() const {
  bool value = (_has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool CMsgGameServerPolicyUpdate::has_app_id() const {
  return _internal_has_app_id();
}
inline void CMsgGameServerPolicyUpdate::clear_app_id() {
  app_id_ = 0u;
  _has_bits_[0] &= ~0x00000001u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 CMsgGameServerPolicyUpdate::_internal_app_id() const {
  return app_id_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 CMsgGameServerPolicyUpdate::app_id() const {
  // @@protoc_insertion_point(field_get:CMsgGameServerPolicyUpdate.app_id)
  return _internal_app_id();
}
inline void CMsgGameServerPolicyUpdate::_internal_set_app_id(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _has_bits_[0] |= 0x00000001u;
  app_id_ = value;
}
inline void CMsgGameServerPolicyUpdate::set_app_id(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_app_id(value);
  // @@protoc_insertion_point(field_set:CMsgGameServerPolicyUpdate.app_id)
}

// optional uint32 app_id_aux = 2;
inline bool CMsgGameServerPolicyUpdate::_internal_has_app_id_aux() const {
  bool value = (_has_bits_[0] & 0x00000002u) != 0;
  return value;
}
inline bool CMsgGameServerPolicyUpdate::has_app_id_aux() const {
  return _internal_has_app_id_aux();
}
inline void CMsgGameServerPolicyUpdate::clear_app_id_aux() {
  app_id_aux_ = 0u;
  _has_bits_[0] &= ~0x00000002u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 CMsgGameServerPolicyUpdate::_internal_app_id_aux() const {
  return app_id_aux_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 CMsgGameServerPolicyUpdate::app_id_aux() const {
  // @@protoc_insertion_point(field_get:CMsgGameServerPolicyUpdate.app_id_aux)
  return _internal_app_id_aux();
}
inline void CMsgGameServerPolicyUpdate::_internal_set_app_id_aux(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _has_bits_[0] |= 0x00000002u;
  app_id_aux_ = value;
}
inline void CMsgGameServerPolicyUpdate::set_app_id_aux(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_app_id_aux(value);
  // @@protoc_insertion_point(field_set:CMsgGameServerPolicyUpdate.app_id_aux)
}
